          ...
          >
            ...
            <div className="flex-1">
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> Factura ID </div>
              ...
              {!isViewMode && (
                <div className="flex flex-row justify-between items-center mb-1">
                  <div className="font-title flex-1"> Tipo de Moneda </div>
                  <div className="font-title flex-1 text-right">
                    <input
                      autoComplete="nope"
                      placeholder="Bs / $"
                    ...
                    >
                      {!isViewMode && (
                        <input
                          ...
                          value={tax.title}
                          type={"text"}
                          placeholder="Título de impuesto"
                          className={defaultInputSmStyle + " text-right"}
                          onChange={(e) =>
            ...
            <div className="flex flex-col flex-wrap sm:flex-row">
              {params.id === "new" && (
                <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                  ...
                  >
                    <CheckCircleIcon className="h-5 w-5 mr-1" /> Guardar plantilla
                  </Button>
                </div>
              )}
